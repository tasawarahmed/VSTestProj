<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Configurations/ConfigurationsMaster.master" AutoEventWireup="true" CodeBehind="Regions.aspx.cs" Inherits="IttefaqConstructionServices.Pages.Configurations.Regions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="cell colspan5">
        ...
        <asp:GridView runat="server" ID="gridRegions" CssClass="table striped hovered border bordered" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
            <Columns>
