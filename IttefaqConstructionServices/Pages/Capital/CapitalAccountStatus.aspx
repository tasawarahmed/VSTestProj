<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Capital/CapitalMaster.master" AutoEventWireup="true" CodeBehind="CapitalAccountStatus.aspx.cs" Inherits="IttefaqConstructionServices.Pages.Capital.CapitalAccountStatus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContents" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h1>Change Capital Account Status:&nbsp<small>Close or Reopen Accounts.</small></h1>
    <hr />
