<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Accounts/AccountsMaster.master" AutoEventWireup="true" CodeBehind="Status.aspx.cs" Inherits="IttefaqConstructionServices.Pages.Accounts.Status" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContents" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h1>Change Account Status:&nbsp<small>Activate and Deactivate Accounts.</small></h1>
    <hr />
