<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/NotForProfit/NotForProfit.master" AutoEventWireup="true" CodeBehind="viewBeneficiaries.aspx.cs" Inherits="IttefaqConstructionServices.Pages.NotForProfit.viewBeneficiaries" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="cell colspan5">
        ...
        <asp:Panel ID="pnlDetails" runat="server" Visible="false">
            <div id="pDiv1">
                <h1>Hamdard Welfare Organization</h1>
