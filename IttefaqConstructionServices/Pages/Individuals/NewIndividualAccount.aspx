<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Individuals/IndividualsMaster.master" AutoEventWireup="true" CodeBehind="NewIndividualAccount.aspx.cs" Inherits="IttefaqConstructionServices.Pages.Individuals.NewIndividualAccount" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContents" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h1>Individuals Account Info:&nbsp<small>Add or change additional information here.</small></h1>
    <hr />
