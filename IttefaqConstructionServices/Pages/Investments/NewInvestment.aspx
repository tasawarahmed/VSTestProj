<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Investments/InvestmentsMaster.master" AutoEventWireup="true" CodeBehind="NewInvestment.aspx.cs" Inherits="IttefaqConstructionServices.Pages.Investments.NewInvestment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContents" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h1>Investments:&nbsp<small>Open new investors accounts here.</small></h1>
    <hr />
