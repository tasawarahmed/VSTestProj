<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Investments/InvestmentsMaster.master" AutoEventWireup="true" CodeBehind="InvestmentStatus.aspx.cs" Inherits="IttefaqConstructionServices.Pages.Investments.InvestmentStatus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContents" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h1>Change Investments Account Status:&nbsp<small>Close or Reopen Accounts.</small></h1>
    <hr />
